...
# Generated on: Thu Dec 02 17:19:36 IST 2021 (Thu Dec 02 11:49:36 GMT 2021)

set lec_version [regsub {(-).} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/demux/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/demux -revised fv_map
...
#add_name_alias fv/demux/fv_map.singlebit.original_name.alias.json.gz -revised
